...
I involved my good friend Piotr from the beginning because he does frontend development professionally. He uses TailwindCSS on a daily basis and he managed to successfully recruit me into the Tailwind club. After some basics and general discussion, I (we) started with the nav bar. Two weeks of education via nav-bar later, I (not we - except when I absolutely needed help) then moved on to the rest of the site.
...
I somehow always find myself selling things. I post these things on various platforms to sell so I figured I'd make a small page to keep track of everything / be a centralized source of info for the items I'm selling.